...
const placeOrder = async (req,res) => {
     try {
        ...
        res.json({success:true,session_url:session.url,message:"Your Order has been placed!"})
     } catch (error) {
        console.log(error);
...
const updateStatus = async (req, res) => {
  try {
    ...
    console.log(error);
    res.json({
      success: false,message: "Failed to update order. Try again later."});
  }
};
